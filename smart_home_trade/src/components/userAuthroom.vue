<template>
	<div class="userAuthroom">
		<el-dialog
		  ...
		  width="30%"
		  :before-close="handleClose" v-loading="pictLoading" element-loading-background="#fff"
                    ...
                    for(var i=0;i<regionList1.length;i++){
                      for(var j=0;j<regionList1[i].manageList.length;j++){
                            ...
                            for(var f=0;f<res.data.data.authDeviceList.length;f++){
                              if(res.data.data.authDeviceList[f]==regionList1[i].manageList[j].id){
                                  regionList1[i].manageList[j].disabled=true;
                               }
                           }
